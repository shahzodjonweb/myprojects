    ...
    <div class="wrapper">
        <div class="tabs">
          <div class="tab">
            ...
            <label for="tab-1" class="tab-label">Loads</label>
          ...
          <div class="tab">
            ...
            <label for="tab-2" class="tab-label">Report</label>
          ...
          {{-- <div class="tab">
            <input type="radio" name="css-tabs" id="tab-3" class="tab-switch" onclick="location.href='{{ route('driver.create') }}'">
            <label for="tab-3" class="tab-label">Report</label>
            <!-- <div class="tab-content">My father now and then sending me small sums of money, I laid them out in learning navigation, and other parts of the mathematics, useful to those who intend to travel, as I always believed it would be, some time or other, my fortune to do. </div> -->
          </div> --}}
          {{-- <div class="tab">
            <input type="radio" name="css-tabs" id="tab-4" class="tab-switch" onclick="location.href='{{ route('driver.create') }}'">
            <label for="tab-4" class="tab-label">Deduction Payment</label>
            <!-- <div class="tab-content">My father now and then sending me small sums of money, I laid them out in learning navigation, and other parts of the mathematics, useful to those who intend to travel, as I always believed it would be, some time or other, my fortune to do. </div> -->
          </div> --}}
          {{-- <div class="tab">
