...
@section('content')
    ...
    <div class="wrapper">
        <div class="tabs">
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-1" checked class="tab-switch" onclick="location.href='{{ route('load.index') }}'">
            <label for="tab-1" class="tab-label">Loads List</label>
          ...
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-2" class="tab-switch" onclick="location.href='{{ url('load/create2') }}'">
          ...
          {{-- <div class="tab">
            <input type="radio" name="css-tabs" id="tab-3" class="tab-switch" onclick="location.href='{{route('customerlist.create')}}'">
            <label for="tab-3" class="tab-label"> All Loads</label>
